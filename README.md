...
<html>
<head>
    <title>Podcast Sample Player</title>
    <style>
        body {
...
<body>
    <h1>Multi-File Podcast Sample</h1>
    <p>This is a sample podcast generated by the Multi-File Podcast Generator.</p>
    
    <div class="player-container">
        <audio controls>
            <source src="examples/podcast_6cdb728c36ab464f85cb66a6b23b5e89.wav" type="audio/wav">
            Your browser does not support the audio element.
        </audio>
    </div>
    
    <div class="github-link">
        <a href="https://github.com/yourusername/multi-file-podcast">Return to GitHub Repository</a>
    </div>
</body>
</html>
